...
// LM Studio icon (chat bubble)
const _lmstudioIcon = `<svg viewBox="0 0 16 16" fill="currentColor"><path d="M2.5 2A1.5 1.5 0 0 0 1 3.5v7A1.5 1.5 0 0 0 2.5 12H5l3 3 3-3h2.5a1.5 1.5 0 0 0 1.5-1.5v-7A1.5 1.5 0 0 0 13.5 2h-11ZM2 3.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5H10.7l-.35.35L8 13.71 5.65 11.35 5.3 11H2.5a.5.5 0 0 1-.5-.5v-7Z"/><circle cx="5" cy="7" r="1"/><circle cx="8" cy="7" r="1"/><circle cx="11" cy="7" r="1"/></svg>`;
