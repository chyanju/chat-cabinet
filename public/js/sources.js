...
// Small inline SVG icons (16x16) for each source, used in tab labels
...
const _terminalIcon = `<svg viewBox="0 0 16 16" fill="currentColor"><path d="M1 3.5A1.5 1.5 0 0 1 2.5 2h11A1.5 1.5 0 0 1 15 3.5v9a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 1 12.5v-9ZM2.5 3a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h11a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5h-11Zm2.15 2.15a.5.5 0 0 1 .7 0l2 2a.5.5 0 0 1 0 .7l-2 2a.5.5 0 0 1-.7-.7L6.29 7.5 4.65 5.85a.5.5 0 0 1 0-.7ZM8 10.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5Z"/></svg>`;
const _cursorIcon = `<svg viewBox="0 0 16 16" fill="currentColor"><path d="M3.29 1.13a.5.5 0 0 1 .54.05l9 7a.5.5 0 0 1-.1.86l-3.44 1.38 2.18 3.93a.5.5 0 0 1-.88.48L8.44 10.9l-2.1 2.86a.5.5 0 0 1-.84-.52V1.5a.5.5 0 0 1 .29-.46l-.5.1Z M6.5 3.37v7.8l1.32-1.8a.5.5 0 0 1 .58-.18l2.74 1.1-5.14-4Z"/></svg>`;
